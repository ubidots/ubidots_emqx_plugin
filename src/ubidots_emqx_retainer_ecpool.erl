...
init_redis_cluster(Pool, Env, EnvVariables, ServerKey, PasswordKey, PoolSizeKey, ReconnectKey) ->
...
start_reactor_pool(PoolReactor, Env, EnvVariables) ->
    ...
    case Type of
        ...
        single -> ecpool:start_pool(PoolReactor, ubidots_emqx_reactor_redis_cli, get_ecpool_reactor_options(EnvVariables) ++ Env)
    end.
...
start_core_pool(PoolCore, Env, EnvVariables) ->
    ...
    case Type of
        ...
        single -> ecpool:start_pool(PoolCore, ubidots_emqx_core_redis_cli, get_ecpool_ubidots_options(EnvVariables) ++ Env)
    end.
